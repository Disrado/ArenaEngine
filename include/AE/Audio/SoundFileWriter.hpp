...
///
/// To register a new writer, use the ae::SoundFileFactory::registerWriter
/// template function.
///
/// Usage example:
/// \code
/// class MySoundFileWriter : public ae::SoundFileWriter
/// {
/// public:
///
...
///     }
///
///     virtual void write(const ae::Int16* samples, ae::Uint64 count)
///     {
...
/// \endcode
///
/// \see ae::OutputSoundFile, ae::SoundFileFactory, ae::SoundFileReader
///
////////////////////////////////////////////////////////////
