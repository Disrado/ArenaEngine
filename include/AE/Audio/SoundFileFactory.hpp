...
#include <AE/Audio/SoundFileFactory.inl>

#endif // SFML_SOUNDFILEFACTORY_HPP


////////////////////////////////////////////////////////////
/// \class ae::SoundFileFactory
/// \ingroup audio
///
...
/// are wrapped into the higher-level classes ae::InputSoundFile and
/// ae::OutputSoundFile.
///
/// To register a new reader (writer) use the ae::SoundFileFactory::registerReader
...
/// ae::SoundFileFactory::registerWriter<MySoundFileWriter>();
/// \endcode
///
/// \see ae::InputSoundFile, ae::OutputSoundFile, ae::SoundFileReader, ae::SoundFileWriter
///
////////////////////////////////////////////////////////////
