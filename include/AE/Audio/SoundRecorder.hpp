...
public:
    ...
    /// any attempt to use ae::SoundRecorder or one of its derived
    /// classes will fail.
    ///
...
////////////////////////////////////////////////////////////
/// \class ae::SoundRecorder
/// \ingroup audio
///
/// ae::SoundBuffer provides a simple interface to access
...
/// captured data to a sound buffer (see ae::SoundBufferRecorder).
///
...
/// Usage example:
/// \code
/// class CustomRecorder : public ae::SoundRecorder
/// {
///     ~CustomRecorder()
///     {
