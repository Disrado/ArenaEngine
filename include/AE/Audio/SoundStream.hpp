...
////////////////////////////////////////////////////////////
/// \class ae::SoundStream
/// \ingroup audio
///
/// Unlike audio buffers (see ae::SoundBuffer), audio streams
...
///
/// ae::SoundStream is a base class that doesn't care about the
/// stream source, which is left to the derived class. SFML provides
/// a built-in specialization for big files (see ae::Music).
...
/// Usage example:
/// \code
/// class CustomStream : public ae::SoundStream
/// {
/// public:
///
