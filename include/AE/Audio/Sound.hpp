...
#include <AE/Audio/SoundSource.hpp>
...
public:
    ...
    /// thus the ae::SoundBuffer instance must remain alive as long
    ...
    /// to use it. It is called by the ae::SoundBuffer that
...
/// \ingroup audio
///
/// ae::Sound is the class to use to play sounds.
/// It provides:
...
///
/// ae::Sound is perfect for playing short sounds that can
/// fit in memory and require no latency, like foot steps or
/// gun shots. For longer sounds, like background musics
/// or long speeches, rather see ae::Music (which is based
/// on streaming).
///
/// In order to work, a sound must be given a buffer of audio
/// data to play. Audio data (samples) is stored in ae::SoundBuffer,
