...
#include <AE/Audio/SoundBuffer.hpp>
#include <AE/Audio/SoundRecorder.hpp>
#include <vector>
...
////////////////////////////////////////////////////////////
/// \class ae::SoundBufferRecorder
/// \ingroup audio
///
/// ae::SoundBufferRecorder allows to access a recorded sound
/// through a ae::SoundBuffer, so that it can be played, saved
/// to a file, etc.
///
...
/// before using this class (see ae::SoundRecorder for more details
/// about this).
///
/// Usage example:
/// \code
/// if (ae::SoundBufferRecorder::isAvailable())
/// {
///     // Record some audio data
///     ae::SoundBufferRecorder recorder;
///     recorder.start();
///     ...
///     recorder.stop();
///
///     // Get the buffer containing the captured audio data
///     const ae::SoundBuffer& buffer = recorder.getBuffer();
///
