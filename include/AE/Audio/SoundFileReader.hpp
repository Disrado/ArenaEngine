...
///
/// To register a new reader, use the ae::SoundFileFactory::registerReader
/// template function.
///
/// Usage example:
/// \code
/// class MySoundFileReader : public ae::SoundFileReader
/// {
/// public:
///
///     static bool check(ae::InputStream& stream)
///     {
///         // typically, read the first few header bytes and check fields that identify the format
///         // return true if the reader can handle the format
///     }
///
///     virtual bool open(ae::InputStream& stream, Info& info)
///     {
...
///     }
///
///     virtual void seek(ae::Uint64 sampleOffset)
///     {
///         // advance to the sampleOffset-th sample from the beginning of the sound
///     }
///
///     virtual ae::Uint64 read(ae::Int16* samples, ae::Uint64 maxCount)
///     {
...
/// };
///
/// ae::SoundFileFactory::registerReader<MySoundFileReader>();
/// \endcode
///
/// \see ae::InputSoundFile, ae::SoundFileFactory, ae::SoundFileWriter
///
////////////////////////////////////////////////////////////
