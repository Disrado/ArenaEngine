...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Audio/Export.hpp>
#include <AE/Audio/AlResource.hpp>
#include <AE/System/Time.hpp>
#include <string>
#include <vector>
#include <set>
...
public:
    ...
    ///
    /// See the documentation of ae::InputSoundFile for the list
    ...
    ///
    /// See the documentation of ae::OutputSoundFile for the list
    /// of supported formats.
    ///
    ...
    /// (ae::Int16). The total number of samples in this array
...
/// are like texture pixels, and a ae::SoundBuffer is similar to
/// a ae::Texture.
///
/// A sound buffer can be loaded from a file (see loadFromFile()
/// for the complete list of supported formats), from memory, from
/// a custom stream (see ae::InputStream) or directly from an array
/// of samples. It can also be saved back to a file.
///
/// Sound buffers alone are not very useful: they hold the audio data
/// but cannot be played. To do so, you need to use the ae::Sound class,
...
/// indeed a ae::SoundBuffer is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a ae::Sound is a lightweight object, which can use the audio data
...
/// several ae::Sound instances to the same ae::SoundBuffer.
///
/// It is important to note that the ae::Sound instance doesn't
/// copy the buffer that it uses, it only keeps a reference to it.
/// Thus, a ae::SoundBuffer must not be destructed while it is
/// used by a ae::Sound (i.e. never write a function that
/// uses a local ae::SoundBuffer instance for loading a sound).
///
/// Usage example:
/// \code
/// // Declare a new sound buffer
/// ae::SoundBuffer buffer;
///
/// // Load it from a file
...
/// \endcode
///
/// \see ae::Sound, ae::SoundBufferRecorder
///
////////////////////////////////////////////////////////////
