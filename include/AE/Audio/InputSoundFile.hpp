...
////////////////////////////////////////////////////////////
/// \class ae::InputSoundFile
/// \ingroup audio
///
/// This class decodes audio samples from a sound file. It is
/// used internally by higher-level classes such as ae::SoundBuffer
/// and ae::Music, but can also be useful if you want to process
/// or analyze audio files without playing them, or if you want to
/// implement your own version of ae::Music with more specific
/// features.
///
/// Usage example:
/// \code
/// // Open a sound file
/// ae::InputSoundFile file;
...
/// \endcode
///
/// \see ae::SoundFileReader, ae::OutputSoundFile
///
////////////////////////////////////////////////////////////
