...
public:
    ...
    /// functions in the ae::Ftp class, this method can be used
...
/// \ingroup network
///
/// ae::Ftp is a very simple FTP client that allows you
...
/// ae::Ftp::Response to provide this data. The most often used
...
/// ae::Ftp::Response response = ftp.connect("ftp://ftp.myserver.com");
/// if (response.isOk())
...
/// ae::Ftp::DirectoryResponse directory = ftp.getWorkingDirectory();
/// if (directory.isOk())
...
/// response = ftp.upload("local-path/file.txt", "files", ae::Ftp::Ascii);
/// if (response.isOk())
