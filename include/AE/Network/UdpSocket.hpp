...
/// interface uses packets (see ae::Packet), which are easier
/// to use and provide more safety regarding the data that is
/// exchanged. You can look at the ae::Packet class to get
...
/// std::string message = "Hi, I am " + ae::IpAddress::getLocalAddress().toString();
...
/// \endcode
///
/// \see ae::Socket, ae::TcpSocket, ae::Packet
///
////////////////////////////////////////////////////////////
