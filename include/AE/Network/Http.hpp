...
#include <AE/Network/IpAddress.hpp>
#include <AE/Network/TcpSocket.hpp>
...
/// \ingroup network
///
/// ae::Http is a very simple HTTP client that allows you
...
/// \li ae::Http
///
/// ae::Http::Request builds the request that will be
...
///
/// ae::Http::Response parse the response from the web server
/// and provides getters to read them. The response contains:
/// \li a status code
/// \li header fields (that may be answers to the ones that you requested)
/// \li a body, which contains the contents of the requested resource
///
/// ae::Http provides a simple function, SendRequest, to send a
/// ae::Http::Request and return the corresponding ae::Http::Response
/// from the server.
///
/// Usage example:
/// \code
...
/// ae::Http::Request request("features.php");
///
/// // Send the request
/// ae::Http::Response response = http.sendRequest(request);
///
/// // Check the status code and display the result
/// ae::Http::Response::Status status = response.getStatus();
/// if (status == ae::Http::Response::Ok)
/// {
