...
public:
    ...
    ///
    /// In non-blocking mode, if this function returns ae::Socket::Partial,
...
///
/// The high-level interface uses packets (see ae::Packet),
/// which are easier to use and provide more safety regarding
/// the data that is exchanged. You can look at the ae::Packet
...
/// \endcode
///
/// \see ae::Socket, ae::UdpSocket, ae::Packet
///
////////////////////////////////////////////////////////////
