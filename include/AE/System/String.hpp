...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new ae::String from a UTF-8 encoded string
    ///
    /// \param begin Forward iterator to the beginning of the UTF-8 sequence
    /// \param end   Forward iterator to the end of the UTF-8 sequence
    ///
    /// \return A ae::String containing the source string
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new ae::String from a UTF-16 encoded string
    ///
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Create a new ae::String from a UTF-32 encoded string
    ///
    /// This function is provided for consistency, it is equivalent to
    /// using the constructors that takes a const ae::Uint32* or
    /// a std::basic_string<ae::Uint32>.
    ///
...
/// \ingroup system
///
/// ae::String is a utility string class defined mainly for
...
/// s = ae::String("hello", locale);
/// \endcode
///
/// ae::String defines the most important functions of the
/// standard std::string class: removing, random access, iterating,
/// appending, comparing, etc. However it is a simple class
/// provided for convenience, and you may have to consider using
/// a more optimized class if your program requires complex string
/// handling. The automatic conversion functions will then take
/// care of converting your string to ae::String whenever SFML
/// requires it.
///
/// Please note that SFML also defines a low-level, generic
/// interface for Unicode handling, see the ae::Utf classes.
///
////////////////////////////////////////////////////////////
