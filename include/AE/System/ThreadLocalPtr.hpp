...
#include <AE/System/ThreadLocalPtr.inl>
...
////////////////////////////////////////////////////////////
/// \class ae::ThreadLocalPtr
/// \ingroup system
///
/// ae::ThreadLocalPtr is a type-safe wrapper for storing
...
/// MyClass object1;
/// MyClass object2;
/// ae::ThreadLocalPtr<MyClass> objectPtr;
///
/// void thread1()
/// {
...
///     ae::Thread t1(&thread1);
///     ae::Thread t2(&thread2);
///     t1.launch();
///     t2.launch();
///
///     return 0;
