...
public:
    ...
    /// cannot survive after its ae::Thread instance is destroyed.
    ///
    ////////////////////////////////////////////////////////////
    ~Thread();
...
/// in parallel.
///
/// To use a ae::Thread, you construct it directly with the
/// function to execute as the entry point of the thread.
/// ae::Thread has multiple template constructors, which means
...
///
/// The function argument, if any, is copied in the ae::Thread
...
/// owner ae::Thread instance is destroyed before the
...
///
/// Task task;
/// ae::Thread thread(&Task::run, &task);
...
/// kind of situations, you can use mutexes (see ae::Mutex).
///
/// \see ae::Mutex
///
////////////////////////////////////////////////////////////
