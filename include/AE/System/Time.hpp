...
private:
    ...
    /// use ae::seconds, ae::milliseconds or ae::microseconds instead.
    ///
...
/// \ingroup system
///
/// ae::Time encapsulates a time value in a flexible way.
...
/// Usage example:
/// \code
/// ae::Time t1 = ae::seconds(0.1f);
/// Int32 milli = t1.asMilliseconds(); // 100
///
/// ae::Time t2 = ae::milliseconds(30);
/// Int64 micro = t2.asMicroseconds(); // 30000
///
/// ae::Time t3 = ae::microseconds(-800000);
/// float sec = t3.asSeconds(); // -0.8
/// \endcode
///
/// \code
/// void update(ae::Time elapsed)
/// {
///    position += speed * elapsed.asSeconds();
/// }
///
/// update(ae::milliseconds(100));
/// \endcode
///
/// \see ae::Clock
///
