...
public:
    ...
    ///
    /// The mutex passed to ae::Lock is automatically locked.
    ///
    ...
    /// \brief Destructor
    ///
    /// The destructor of ae::Lock automatically unlocks its mutex.
    ///
    ////////////////////////////////////////////////////////////
    ~Lock();
...
/// \ingroup system
///
/// ae::Lock is a RAII wrapper for ae::Mutex. By unlocking
...
/// function.
///
/// For maximum robustness, ae::Lock should always be used
...
/// void function()
/// {
///     ae::Lock lock(mutex); // mutex is now locked
///
