...
protected:
    ...
    /// call delete on a pointer of ae::NonCopyable, thus
...
/// in ae::NonCopyable so they will end up being inaccessible in both
/// cases. Thus you can use a shorter syntax for inheriting from it
/// (see below).
///
/// Usage example:
/// \code
/// class MyNonCopyableClass : ae::NonCopyable
/// {
///     ...
/// };
/// \endcode
...
/// and to use ae::NonCopyable when necessary to prevent
