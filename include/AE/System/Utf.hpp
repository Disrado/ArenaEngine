...
public:
    ...
    /// specializations of the ae::Utf<> template, and allow
...
public:
    ...
    /// of ae::Utf<>, it is defined for convenience (it is used by
...
///
/// ae::Utf is a low-level, generic interface for counting, iterating,
...
///
/// ae::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li ae::Utf<8> (typedef'd to ae::Utf8)
/// \li ae::Utf<16> (typedef'd to ae::Utf16)
/// \li ae::Utf<32> (typedef'd to ae::Utf32)
///
////////////////////////////////////////////////////////////
