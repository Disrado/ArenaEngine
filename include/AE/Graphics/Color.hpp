...
/// \ingroup graphics
///
/// ae::Color is a simple color class composed of 4 components:
/// \li Red
/// \li Green
/// \li Blue
/// \li Alpha (opacity)
...
/// ae::Color white       = ae::Color::White;
/// ae::Color red         = ae::Color::Red;
/// ae::Color green       = ae::Color::Green;
/// ae::Color blue        = ae::Color::Blue;
/// ae::Color yellow      = ae::Color::Yellow;
/// ae::Color magenta     = ae::Color::Magenta;
/// ae::Color cyan        = ae::Color::Cyan;
/// ae::Color transparent = ae::Color::Transparent;
/// \endcode
///
