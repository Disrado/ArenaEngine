...
/// (Vector2 and Vector3).
///
/// To keep things simple, ae::Rect doesn't define
/// functions to emulate the properties that are not directly
/// members (such as right, bottom, center, etc.), it rather
/// only provides intersection functions.
///
/// ae::Rect uses the usual rules for its boundaries:
/// \li The left and top edges are included in the rectangle's area
/// \li The right (left + width) and bottom (top + height) edges are excluded from the rectangle's area
///
/// This means that ae::IntRect(0, 0, 1, 1) and ae::IntRect(1, 1, 1, 1)
/// don't intersect.
///
/// ae::Rect is a template and may be used with any numeric type, but
/// for simplicity the instantiations used by SFML are typedef'd:
/// \li ae::Rect<int> is ae::IntRect
/// \li ae::Rect<float> is ae::FloatRect
///
...
/// ae::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with a size of 18x10
/// ae::Vector2i position(4, 2);
/// ae::Vector2i size(18, 10);
/// ae::IntRect r2(position, size);
///
