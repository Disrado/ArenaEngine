...
public:
    ...
    /// to using ae::RenderStates::Default.
...
/// function: ae::RenderStates has an implicit one-argument
...
/// object (inherited from ae::Drawable), you can
...
/// set its texture. Etc.
///
/// \see ae::RenderTarget, ae::Drawable
///
////////////////////////////////////////////////////////////
