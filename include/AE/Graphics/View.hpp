...
public:
    ...
    /// be defined with View.setViewport(ae::FloatRect(0, 0, 0.5, 1)).
...
/// \ingroup graphics
///
/// ae::View defines a camera in the 2D scene. This is a
...
/// Usage example:
/// \code
/// ae::RenderWindow window;
/// ae::View view;
///
/// // Initialize the view to a rectangle located at (100, 100) and with a size of 400x200
/// view.reset(ae::FloatRect(100, 100, 400, 200));
///
/// // Rotate it by 45 degrees
/// view.rotate(45);
///
/// // Set its target viewport to be half of the window
/// view.setViewport(ae::FloatRect(0.f, 0.f, 0.5f, 1.f));
///
/// // Apply it
/// window.setView(view);
///
...
///
/// \see ae::RenderWindow, ae::RenderTexture
///
////////////////////////////////////////////////////////////
