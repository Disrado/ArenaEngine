...
public:
    ...
    /// mix ae::Texture with OpenGL code.
    ///
    /// \code
    /// ae::Texture t1, t2;
    /// ...
...
/// \ingroup graphics
///
/// ae::Texture stores pixels that can be drawn, with a sprite
...
/// A texture cannot be manipulated as freely as a ae::Image,
/// you need to prepare the pixels first and then upload them
/// to the texture in a single operation (see Texture::update).
///
/// ae::Texture makes it easy to convert from/to ae::Image, but
...
/// ae::Image, do whatever you need with the pixels, and then call
...
/// of booleans.
///
/// Like ae::Image, ae::Texture can handle a unique internal
/// representation of pixels, which is RGBA 32 bits. This means
/// that a pixel must be composed of 8 bits red, green, blue and
/// alpha channels -- just like a ae::Color.
///
/// Usage example:
/// \code
/// // This example shows the most common use of ae::Texture:
/// // drawing a sprite
///
...
///
/// \code
/// // This example shows another common use of ae::Texture:
...
///
///     // update the texture
///     ae::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
...
/// \endcode
///
/// Like ae::Shader that can be used as a raw OpenGL shader,
/// ae::Texture can also be used directly as a raw texture for
/// custom OpenGL geometry.
/// \code
/// ae::Texture::bind(&texture);
/// ... render OpenGL geometry ...
/// ae::Texture::bind(NULL);
/// \endcode
///
/// \see ae::Sprite, ae::Image, ae::RenderTexture
///
////////////////////////////////////////////////////////////
