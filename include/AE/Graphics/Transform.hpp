...
public:
    ...
    /// \code
    /// ae::Transform transform;
    /// transform.translate(ae::Vector2f(100, 200)).rotate(45);
    /// \endcode
    ///
    ...
    /// \code
    /// ae::Transform transform;
    /// transform.rotate(90, ae::Vector2f(8, 3)).translate(ae::Vector2f(50, 20));
    /// \endcode
    ///
    /// \param angle Rotation angle, in degrees
    ...
    /// \code
    /// ae::Transform transform;
    /// transform.scale(ae::Vector2f(2, 1)).rotate(45);
    /// \endcode
    ///
    ...
    /// \code
    /// ae::Transform transform;
    /// transform.scale(ae::Vector2f(2, 1), ae::Vector2f(8, 3)).rotate(45);
    /// \endcode
    ///
    /// \param factors Scaling factors
...
/// \ingroup graphics
///
/// A ae::Transform specifies how to translate, rotate, scale,
...
/// ae::Transform translation;
/// translation.translate(20, 50);
///
/// // define a rotation transform
/// ae::Transform rotation;
/// rotation.rotate(45);
///
/// // combine them
/// ae::Transform transform = translation * rotation;
///
/// // use the result to transform stuff...
/// ae::Vector2f point = transform.transformPoint(10, 20);
/// ae::FloatRect rect = transform.transformRect(ae::FloatRect(0, 0, 10, 100));
/// \endcode
///
/// \see ae::Transformable, ae::RenderStates
///
////////////////////////////////////////////////////////////
