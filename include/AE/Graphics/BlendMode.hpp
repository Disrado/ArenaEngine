...
/// \ingroup graphics
///
/// ae::BlendMode is a class that represents a blend mode. A blend
...
///
/// \code
/// ae::BlendMode alphaBlending          = ae::BlendAlpha;
/// ae::BlendMode additiveBlending       = ae::BlendAdd;
/// ae::BlendMode multiplicativeBlending = ae::BlendMultiply;
/// ae::BlendMode noBlending             = ae::BlendNone;
/// \endcode
///
/// In SFML, a blend mode can be specified every time you draw a ae::Drawable
/// object to a render target. It is part of the ae::RenderStates compound
/// that is passed to the member function ae::RenderTarget::draw().
///
/// \see ae::RenderStates, ae::RenderTarget
///
////////////////////////////////////////////////////////////
