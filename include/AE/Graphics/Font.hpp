...
public:
    ...
    /// the ae::Font object loads a new font or is destroyed.
    ///
    ...
    /// valid until the ae::Font object loads a new font or
    /// is destroyed.
    ///
...
///
/// Once it is loaded, a ae::Font instance provides three
...
/// use the ae::Text class, which is able to properly output text
/// with several options such as character size, style, color,
/// position, rotation, etc.
/// This separation allows more flexibility and better performances:
/// indeed a ae::Font is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a ae::Text is a lightweight object which can combine the
/// glyphs data and metrics of a ae::Font to display any text on a
/// render target.
/// Note that it is also possible to bind several ae::Text instances
/// to the same ae::Font.
///
...
/// text1.setStyle(ae::Text::Regular);
///
/// // Create another text using the same font, but with different parameters
/// ae::Text text2;
/// text2.setFont(font);
/// text2.setCharacterSize(50);
/// text2.setStyle(ae::Text::Italic);
/// \endcode
///
/// Apart from loading font files, and passing them to instances
/// of ae::Text, you should normally not have to deal directly
/// with this class. However, it may be useful to access the
/// font metrics or rasterized glyphs for advanced usage.
///
/// Note that if the font is a bitmap font, it is not scalable,
/// thus not all requested sizes will be available to use. This
/// needs to be taken into consideration when using ae::Text.
