...
public:
    ...
    /// \li As triangles
    /// \li As quads
    /// The default primitive type is ae::Points.
    ///
...
/// \ingroup graphics
///
/// ae::VertexArray is a very simple wrapper around a dynamic
/// array of vertices and a primitives type.
///
/// It inherits ae::Drawable, but unlike other drawables it
/// is not transformable.
///
/// Example:
/// \code
/// ae::VertexArray lines(ae::LineStrip, 4);
/// lines[0].position = ae::Vector2f(10, 0);
/// lines[1].position = ae::Vector2f(20, 0);
/// lines[2].position = ae::Vector2f(30, 5);
/// lines[3].position = ae::Vector2f(40, 2);
///
/// window.draw(lines);
/// \endcode
///
