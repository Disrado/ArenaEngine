...
public:
    ...
    /// \code
    /// ae::Vector2f pos = object.getPosition();
    ...
    /// Thus, it is equivalent to the following code:
    /// \code
    /// ae::Vector2f scale = object.getScale();
...
/// \ingroup graphics
///
/// This class is provided for convenience, on top of ae::Transform.
///
/// ae::Transform, as a low-level class, offers a great level of
...
///
/// That's exactly what ae::Transformable was written for: it hides
...
/// transform (as a ae::Transform), and keeps it up-to-date.
///
/// In addition to the position, rotation and scale, ae::Transformable
...
/// bottom-right corner.
///
/// To keep the ae::Transformable class simple, there's only one
/// origin for all the components. You cannot position the sprite
/// relatively to its top-left corner while rotating it around its
/// center, for example. To do such things, use ae::Transform directly.
///
/// ae::Transformable can be used as a base class. It is often
/// combined with ae::Drawable -- that's what SFML's sprites,
/// texts and shapes do.
/// \code
/// class MyEntity : public ae::Transformable, public ae::Drawable
/// {
///     virtual void draw(ae::RenderTarget& target, ae::RenderStates states) const
///     {
...
///     }
///
///     void Draw(ae::RenderTarget& target) const
///     {
///         target.draw(..., myTransform.getTransform());
///     }
///
/// private:
///     ae::Transformable myTransform;
/// };
/// \endcode
///
...
/// In order to render a ae::Drawable object pixel-perfectly, make sure
