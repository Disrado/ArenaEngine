...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Graphics/Transform.hpp>
#include <AE/Graphics/Color.hpp>
...
namespace Glsl
{
    ...
    ///
    /// 4D float vectors can be implicitly converted from ae::Color
    /// instances. Each color channel is normalized from integers
    /// in [0, 255] to floating point values in [0, 1].
    /// \code
    /// ae::Glsl::Vec4 zeroVector;
    /// ae::Glsl::Vec4 vector(1.f, 2.f, 3.f, 4.f);
    /// ae::Glsl::Vec4 color = ae::Color::Cyan;
    /// \endcode
    ////////////////////////////////////////////////////////////
    ...
    ///
    /// 4D int vectors can be implicitly converted from ae::Color
    /// instances. Each color channel remains unchanged inside
    /// the integer interval [0, 255].
    /// \code
    /// ae::Glsl::Ivec4 zeroVector;
    /// ae::Glsl::Ivec4 vector(1, 2, 3, 4);
    /// ae::Glsl::Ivec4 color = ae::Color::Cyan;
    /// \endcode
    ////////////////////////////////////////////////////////////
    ...
    /// };
    ///
    /// ae::Glsl::Mat3 matrix(array);
    /// \endcode
    ///
    /// Mat3 can also be implicitly converted from ae::Transform:
    /// \code
    /// ae::Transform transform;
    /// ae::Glsl::Mat3 matrix = transform;
    /// \endcode
    ////////////////////////////////////////////////////////////
    ...
    /// };
    ///
    /// ae::Glsl::Mat4 matrix(array);
    /// \endcode
    ///
    /// Mat4 can also be implicitly converted from ae::Transform:
    /// \code
    /// ae::Transform transform;
    /// ae::Glsl::Mat4 matrix = transform;
    /// \endcode
    ////////////////////////////////////////////////////////////
...
/// \ingroup graphics
///
/// \details The ae::Glsl namespace contains types that match
/// their equivalents in GLSL, the OpenGL shading language.
/// These types are exclusively used by the ae::Shader class.
///
/// Types that already exist in SFML, such as \ref ae::Vector2<T>
/// and \ref ae::Vector3<T>, are reused as typedefs, so you can use
...
/// Furthermore, they can be converted from ae::Transform
/// objects.
///
/// \see ae::Shader
///
