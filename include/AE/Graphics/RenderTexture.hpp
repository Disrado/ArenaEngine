...
public:
    ...
    /// The internal ae::Texture of a render-texture is always the
...
/// \ingroup graphics
///
/// ae::RenderTexture is the little brother of ae::RenderWindow.
/// It implements the same 2D drawing and OpenGL-related functions
/// (see their base class ae::RenderTarget for more details),
...
///    texture.clear(ae::Color::Red);
///
///    // Draw stuff to the texture
///    texture.draw(sprite);  // sprite is a ae::Sprite
///    texture.draw(shape);   // shape is a ae::Shape
///    texture.draw(text);    // text is a ae::Text
///
...
///
///    // Draw the texture
///    ae::Sprite sprite(texture.getTexture());
///    window.draw(sprite);
///
...
/// \endcode
///
/// Like ae::RenderWindow, ae::RenderTexture is still able to render direct
/// OpenGL stuff. It is even possible to mix together OpenGL calls
/// and regular SFML drawing commands. If you need a depth buffer for
/// 3D rendering, don't forget to request it when calling RenderTexture::create.
///
/// \see ae::RenderTarget, ae::RenderWindow, ae::View, ae::Texture
///
////////////////////////////////////////////////////////////
