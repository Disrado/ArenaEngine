...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Window/Export.hpp>
#include <AE/Window/ContextSettings.hpp>
#include <AE/Window/VideoMode.hpp>
#include <AE/Window/WindowHandle.hpp>
#include <AE/Window/WindowStyle.hpp>
#include <AE/Window/GlResource.hpp>
#include <AE/System/Clock.hpp>
...
public:
    ...
    ///
    /// After calling this function, the ae::Window instance remains
    ...
    /// but since it internally uses ae::sleep, whose precision
    ...
    ///
    /// The type of the returned handle is ae::WindowHandle,
...
/// \ingroup window
///
/// ae::Window is the main class of the Window module. It defines
/// an OS window that is able to receive an OpenGL rendering.
///
/// A ae::Window can create its own new window, or be embedded into
...
///
/// The ae::Window class provides a simple interface for manipulating
...
/// OpenGL context attached to the window, with the ae::ContextSettings
...
/// ae::Window window(ae::VideoMode(800, 600), "SFML window");
///
