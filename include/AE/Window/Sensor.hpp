...
/// \ingroup window
///
/// ae::Sensor provides an interface to the state of the
...
/// its events. Compared to the SensorChanged event, ae::Sensor
...
/// ae::Sensor::isAvailable function.
///
...
/// all disabled by default. You must call ae::Sensor::setEnabled for each
/// sensor in which you are interested.
///
/// Usage example:
/// \code
/// if (ae::Sensor::isAvailable(ae::Sensor::Gravity))
/// {
///     // gravity sensor is available
/// }
///
/// // enable the gravity sensor
/// ae::Sensor::setEnabled(ae::Sensor::Gravity, true);
///
/// // get the current value of gravity
/// ae::Vector3f gravity = ae::Sensor::getValue(ae::Sensor::Gravity);
/// \endcode
///
////////////////////////////////////////////////////////////
