...
/// setup windows (ae::Window) at creation time.
///
...
///
/// ae::VideoMode provides a static function for retrieving
...
///
/// Additionally, ae::VideoMode provides a static function
...
/// std::vector<ae::VideoMode> modes = ae::VideoMode::getFullscreenModes();
/// for (std::size_t i = 0; i < modes.size(); ++i)
/// {
///     ae::VideoMode mode = modes[i];
///     std::cout << "Mode #" << i << ": "
...
/// ae::VideoMode desktop = ae::VideoMode::getDesktopMode();
/// window.create(ae::VideoMode(1024, 768, desktop.bitsPerPixel), "SFML window");
/// \endcode
///
////////////////////////////////////////////////////////////
