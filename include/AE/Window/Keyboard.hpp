...
/// \ingroup window
///
/// ae::Keyboard provides an interface to the state of the
...
/// ae::Keyboard can retrieve the state of a key at any time
...
///     // move left...
/// }
/// else if (ae::Keyboard::isKeyPressed(ae::Keyboard::Right))
/// {
///     // move right...
/// }
/// else if (ae::Keyboard::isKeyPressed(ae::Keyboard::Escape))
/// {
///     // quit...
/// }
/// \endcode
///
/// \see ae::Joystick, ae::Mouse, ae::Touch
///
////////////////////////////////////////////////////////////
