...
/// \ingroup window
///
/// ae::Touch provides an interface to the state of the
...
/// and TouchEnded events, ae::Touch can retrieve the
...
/// Usage example:
/// \code
/// if (ae::Touch::isDown(0))
/// {
///     // touch 0 is down
/// }
///
/// // get global position of touch 1
/// ae::Vector2i globalPos = ae::Touch::getPosition(1);
///
/// // get position of touch 1 relative to a window
/// ae::Vector2i relativePos = ae::Touch::getPosition(1, window);
/// \endcode
///
/// \see ae::Joystick, ae::Keyboard, ae::Mouse
///
////////////////////////////////////////////////////////////
