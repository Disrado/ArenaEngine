...
/// \ingroup window
///
/// ae::Mouse provides an interface to the state of the
...
/// and MouseButtonReleased events, ae::Mouse can retrieve the
...
/// Usage example:
/// \code
/// if (ae::Mouse::isButtonPressed(ae::Mouse::Left))
/// {
///     // left click...
/// }
///
/// // get global mouse position
/// ae::Vector2i position = ae::Mouse::getPosition();
///
/// // set mouse position relative to a window
/// ae::Mouse::setPosition(ae::Vector2i(100, 200), window);
/// \endcode
///
/// \see ae::Joystick, ae::Keyboard, ae::Touch
///
////////////////////////////////////////////////////////////
