...
/// \ingroup window
///
/// ae::Joystick provides an interface to the state of the
...
/// and JoystickButtonReleased events, ae::Joystick can retrieve the
...
///
/// SFML supports:
/// \li 8 joysticks (ae::Joystick::Count)
/// \li 32 buttons per joystick (ae::Joystick::ButtonCount)
/// \li 8 axes per joystick (ae::Joystick::AxisCount)
///
...
/// you must call ae::Joystick::update explicitly.
///
/// Usage example:
/// \code
/// // Is joystick #0 connected?
/// bool connected = ae::Joystick::isConnected(0);
///
/// // How many buttons does joystick #0 support?
/// unsigned int buttons = ae::Joystick::getButtonCount(0);
///
/// // Does joystick #0 define a X axis?
/// bool hasX = ae::Joystick::hasAxis(0, ae::Joystick::X);
///
/// // Is button #2 pressed on joystick #0?
/// bool pressed = ae::Joystick::isButtonPressed(0, 2);
///
/// // What's the current position of the Y axis on joystick #0?
/// float position = ae::Joystick::getAxisPosition(0, ae::Joystick::Y);
/// \endcode
///
/// \see ae::Keyboard, ae::Mouse
///
////////////////////////////////////////////////////////////
