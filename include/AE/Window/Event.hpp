...
#include <AE/Window/Joystick.hpp>
#include <AE/Window/Keyboard.hpp>
#include <AE/Window/Mouse.hpp>
#include <AE/Window/Sensor.hpp>
...
/// \ingroup window
///
/// ae::Event holds all the informations about a system event
/// that just happened. Events are retrieved using the
/// ae::Window::pollEvent and ae::Window::waitEvent functions.
///
/// A ae::Event instance contains the type of the event
...
///     if ((event.type == ae::Event::KeyPressed) && (event.key.code == ae::Keyboard::Escape))
///         window.close();
///
///     // The window was resized
///     if (event.type == ae::Event::Resized)
