...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Config.hpp>

#ifdef SFML_SYSTEM_ANDROID

#include <AE/System/Android/Activity.hpp>
#include <AE/System/Sleep.hpp>
#include <AE/System/Thread.hpp>
...
void goToFullscreenMode(ANativeActivity* activity)
{
    ...
    int apiLevel = ae::priv::getAndroidApiLevel(activity);
...
static void onResume(ANativeActivity* activity)
{
    ...
    ae::priv::ActivityStates* states = ae::priv::retrieveStates(activity);
    ae::Lock lock(states->mutex);
    ...
    ae::Event event;
    event.type = ae::Event::MouseEntered;
...
static void onNativeWindowCreated(ANativeActivity* activity, ANativeWindow* window)
{
    ...
    ae::Event event;
    event.type = ae::Event::GainedFocus;
    states->forwardEvent(event);
...
void ANativeActivity_onCreate(ANativeActivity* activity, void* savedState, size_t savedStateSize)
{
    ...
    ae::priv::ActivityStates* states = NULL;
    states = new ae::priv::ActivityStates;
    ...
    for (unsigned int i = 0; i < ae::Mouse::ButtonCount; i++)
    ...
    ae::priv::getActivity(states, true);
    ...
    ae::err().rdbuf(&states->logcat);

    // Launch the main thread
    ae::Thread* thread = new ae::Thread(ae::priv::main, states);
    thread->launch();
