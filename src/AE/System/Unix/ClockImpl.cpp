...
// Headers
////////////////////////////////////////////////////////////
#include <AE/System/Unix/ClockImpl.hpp>
...
Time ClockImpl::getCurrentTime()
{
    ...
    return ae::microseconds(nanoseconds / 1000);
    ...
    return ae::microseconds(static_cast<Uint64>(time.tv_sec) * 1000000 + time.tv_nsec / 1000);
