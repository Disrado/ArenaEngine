...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Audio/AudioDevice.hpp>
#include <AE/Audio/ALCheck.hpp>
#include <AE/Audio/Listener.hpp>
...
namespace
{
    ...
    ae::Vector3f listenerPosition (0.f, 0.f, 0.f);
    ae::Vector3f listenerDirection(0.f, 0.f, -1.f);
    ae::Vector3f listenerUpVector (0.f, 1.f, 0.f);
}
