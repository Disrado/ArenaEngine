...
namespace
{
    ...
    bool decode(ae::InputStream& stream, ae::Uint8& value)
    {
         return stream.read(&value, sizeof(value)) == sizeof(value);
    }

    bool decode(ae::InputStream& stream, ae::Int16& value)
    {
    ...
    bool decode(ae::InputStream& stream, ae::Uint16& value)
    {
        unsigned char bytes[sizeof(value)];
        if (stream.read(bytes, sizeof(bytes)) != sizeof(bytes))
            return false;
    ...
    bool decode24bit(ae::InputStream& stream, ae::Uint32& value)
    {
    ...
    bool decode(ae::InputStream& stream, ae::Uint32& value)
    {
        unsigned char bytes[sizeof(value)];
        if (stream.read(bytes, sizeof(bytes)) != sizeof(bytes))
            return false;
    ...
    const ae::Uint64 mainChunkSize = 12;
}
