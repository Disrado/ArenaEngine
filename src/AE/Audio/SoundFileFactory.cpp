...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Audio/SoundFileFactory.hpp>
#include <AE/Audio/SoundFileReaderFlac.hpp>
#include <AE/Audio/SoundFileWriterFlac.hpp>
#include <AE/Audio/SoundFileReaderOgg.hpp>
#include <AE/Audio/SoundFileWriterOgg.hpp>
#include <AE/Audio/SoundFileReaderWav.hpp>
#include <AE/Audio/SoundFileWriterWav.hpp>
...
namespace
{
    ...
    void ensureDefaultReadersWritersRegistered()
    {
        ...
        if (!registered)
        {
            ae::SoundFileFactory::registerReader<ae::priv::SoundFileReaderFlac>();
            ae::SoundFileFactory::registerWriter<ae::priv::SoundFileWriterFlac>();
            ae::SoundFileFactory::registerReader<ae::priv::SoundFileReaderOgg>();
            ae::SoundFileFactory::registerWriter<ae::priv::SoundFileWriterOgg>();
            ae::SoundFileFactory::registerReader<ae::priv::SoundFileReaderWav>();
            ae::SoundFileFactory::registerWriter<ae::priv::SoundFileWriterWav>();
            registered = true;
        }
    }
}
