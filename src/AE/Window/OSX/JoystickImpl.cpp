...
#include <AE/Window/OSX/HIDInputManager.hpp>
#include <AE/Window/OSX/HIDJoystickManager.hpp>
...
namespace
{
    ...
    std::string getDeviceString(IOHIDDeviceRef ref, CFStringRef prop, unsigned int index)
    {
        ...
        ae::err() << "Unable to read string value for property '" << stringFromCFString(prop) << "' for joystick at index " << index << std::endl;
    ...
    unsigned int getDeviceUint(IOHIDDeviceRef ref, CFStringRef prop, unsigned int index)
    {
        ...
        ae::err() << "Unable to read uint value for property '" << stringFromCFString(prop) << "' for joystick at index " << index << std::endl;
        return 0;
    }
}
...
{
////////////////////////////////////////////////////////////
JoystickImpl::Location JoystickImpl::m_locationIDs[ae::Joystick::Count] = { 0 };
...
bool JoystickImpl::isConnected(unsigned int index)
{
    ...
    else
    {
        ...
        for (unsigned int i(0); i < ae::Joystick::Count; ++i)
        {
