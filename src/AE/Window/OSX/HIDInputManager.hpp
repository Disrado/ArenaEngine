...
////////////////////////////////////////////////////////////
/// \brief ae::priv::InputImpl helper
///
/// This class manage as a singleton instance the keyboard state.
/// Its purpose is to help ae::priv::InputImpl class.
///
////////////////////////////////////////////////////////////
...
public:
    ...
    ///
    /// Return ae::Keyboard::Unknown if it doesn't match any 'localized' keys.
    ///
    ...
    ///
    /// Return ae::Keyboard::Unknown if the keycode is unknown.
    ///
    ////////////////////////////////////////////////////////////
...
private:
    ...
    ////////////////////////////////////////////////////////////
    /// m_keys' index corresponds to ae::Keyboard::Key enum.
    ...
    /// with the same ae::Keyboard::Key then m_keys[XYZ] contains all these
    /// HID keys.
    ///
    ////////////////////////////////////////////////////////////
};
