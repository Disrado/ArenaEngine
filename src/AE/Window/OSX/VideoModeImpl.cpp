...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Window/VideoModeImpl.hpp>
#include <AE/Window/OSX/cg_sf_conversion.hpp>
...
std::vector<VideoMode> VideoModeImpl::getFullscreenModes()
{
    ...
    if (cgmodes == NULL)
    {
        ae::err() << "Couldn't get VideoMode for main display." << std::endl;
        return modes;
    }

    VideoMode desktop = getDesktopMode();

    // Loop on each mode and convert it into a ae::VideoMode object.
