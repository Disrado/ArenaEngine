...
#include <cassert>
        ...
        #include <AE/Window/Win32/WglContext.hpp>
        typedef ae::priv::WglContext ContextType;
        ...
        #include <AE/Window/OSX/SFContext.hpp>
        typedef ae::priv::SFContext ContextType;
        ...
        #include <AE/Window/iOS/EaglContext.hpp>
        typedef ae::priv::EaglContext ContextType;
...
namespace
{
    ...
    ae::ThreadLocalPtr<ae::priv::GlContext> currentContext(NULL);
    ...
    struct TransientContext : private ae::NonCopyable
    {
        ////////////////////////////////////////////////////////////
        /// \brief Constructor
        ///
        ...
        useSharedContext (false)
        {
            if (resourceCount == 0)
            {
                context = new ae::Context;
            }
            else if (!currentContext)
            {
                sharedContextLock = new ae::Lock(mutex);
    ...
    ae::ThreadLocalPtr<TransientContext> transientContext(NULL);
