...
struct JoystickState
{
    ...
    #include <AE/Window/Win32/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_LINUX)

    #include <AE/Window/Unix/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_FREEBSD)

    #include <AE/Window/FreeBSD/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_MACOS)

    #include <AE/Window/OSX/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_IOS)

    #include <AE/Window/iOS/JoystickImpl.hpp>

#elif defined(SFML_SYSTEM_ANDROID)

    #include <AE/Window/Android/JoystickImpl.hpp>
