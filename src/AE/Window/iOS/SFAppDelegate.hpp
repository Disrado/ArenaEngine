...
///
////////////////////////////////////////////////////////////
- (ae::Vector2i)getTouchPosition:(unsigned int)index;
...
///
////////////////////////////////////////////////////////////
- (void)notifyTouchBegin:(unsigned int)index atPosition:(ae::Vector2i)position;
...
///
////////////////////////////////////////////////////////////
- (void)notifyTouchMove:(unsigned int)index atPosition:(ae::Vector2i)position;
...
///
////////////////////////////////////////////////////////////
- (void)notifyTouchEnd:(unsigned int)index atPosition:(ae::Vector2i)position;
...
///
////////////////////////////////////////////////////////////
- (void)notifyCharacter:(ae::Uint32)character;
...
// Member data
////////////////////////////////////////////////////////////
@property (nonatomic) ae::priv::WindowImplUIKit* sfWindow; ///< Main window of the application
