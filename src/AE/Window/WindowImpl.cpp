...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Window/WindowImpl.hpp>
#include <AE/Window/Event.hpp>
#include <AE/Window/JoystickManager.hpp>
#include <AE/Window/SensorManager.hpp>
...
#include <cmath>
    ...
    #include <AE/Window/Win32/WindowImplWin32.hpp>
    typedef ae::priv::WindowImplWin32 WindowImplType;

#elif defined(SFML_SYSTEM_LINUX) || defined(SFML_SYSTEM_FREEBSD)

    #include <AE/Window/Unix/WindowImplX11.hpp>
    typedef ae::priv::WindowImplX11 WindowImplType;

#elif defined(SFML_SYSTEM_MACOS)

    #include <AE/Window/OSX/WindowImplCocoa.hpp>
    typedef ae::priv::WindowImplCocoa WindowImplType;

#elif defined(SFML_SYSTEM_IOS)

    #include <AE/Window/iOS/WindowImplUIKit.hpp>
    typedef ae::priv::WindowImplUIKit WindowImplType;

#elif defined(SFML_SYSTEM_ANDROID)

    #include <AE/Window/Android/WindowImplAndroid.hpp>
    typedef ae::priv::WindowImplAndroid WindowImplType;
