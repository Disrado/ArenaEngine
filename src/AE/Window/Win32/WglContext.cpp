...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Window/WindowImpl.hpp> // included first to avoid a warning about macro redefinition
#include <AE/OpenGL.hpp> // included second to avoid an error in WglExtensions.hpp
...
namespace
{
    ...
    ae::ThreadLocalPtr<ae::priv::WglContext> currentContext(NULL);
}
