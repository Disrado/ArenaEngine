...
namespace
{
    ...
    void updatePluggedList()
    {
        ...
        if (directory)
        {
            ...
            while (directoryEntry && joystickCount < ae::Joystick::Count)
            {
    ...
    int usageToAxis(int usage)
    {
        switch (usage)
        {
            case HUG_X:  return ae::Joystick::X;
            case HUG_Y:  return ae::Joystick::Y;
            case HUG_Z:  return ae::Joystick::Z;
            case HUG_RZ: return ae::Joystick::R;
            case HUG_RX: return ae::Joystick::U;
            case HUG_RY: return ae::Joystick::V;
            default:     return -1;
        }
    }

    void hatValueToSfml(int value, ae::priv::JoystickState& state)
    {
        state.axes[ae::Joystick::PovX] = hatValueMap[value].first;
        state.axes[ae::Joystick::PovY] = hatValueMap[value].second;
    }
}
