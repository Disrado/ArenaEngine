...
#include <AE/Graphics/GLCheck.hpp>
    ...
    #include <AE/System/Android/ResourceStream.hpp>
#endif
...
namespace
{
    // FreeType callbacks that operate on a ae::InputStream
    unsigned long read(FT_Stream rec, unsigned long offset, unsigned char* buffer, unsigned long count)
    {
        ae::InputStream* stream = static_cast<ae::InputStream*>(rec->descriptor.pointer);
