...
namespace
{
		 ...
		 float            outlineThickness = 0)
    {
        ...
        vertices.append(ae::Vertex(ae::Vector2f(-outlineThickness,             top    - outlineThickness), color, ae::Vector2f(1, 1)));
        vertices.append(ae::Vertex(ae::Vector2f(lineLength + outlineThickness, top    - outlineThickness), color, ae::Vector2f(1, 1)));
        vertices.append(ae::Vertex(ae::Vector2f(-outlineThickness,             bottom + outlineThickness), color, ae::Vector2f(1, 1)));
        vertices.append(ae::Vertex(ae::Vector2f(-outlineThickness,             bottom + outlineThickness), color, ae::Vector2f(1, 1)));
        vertices.append(ae::Vertex(ae::Vector2f(lineLength + outlineThickness, top    - outlineThickness), color, ae::Vector2f(1, 1)));
        vertices.append(ae::Vertex(ae::Vector2f(lineLength + outlineThickness, bottom + outlineThickness), color, ae::Vector2f(1, 1)));
    }
