...
// Headers
////////////////////////////////////////////////////////////
#include <AE/Graphics/GLLoader.hpp>
#include <AE/Window/Context.hpp>

static ae::GlFunctionPointer glLoaderGetProcAddress(const char* name)
{
    return ae::Context::getFunction(name);
}
...
void sfogl_LoadFunctions()
{
    ...
    {
        if (ae::Context::isExtensionAvailable(ExtensionMap[i].extensionName))
