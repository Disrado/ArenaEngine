...
namespace
{
    ...
    ae::Vector2f computeNormal(const ae::Vector2f& p1, const ae::Vector2f& p2)
    {
        ae::Vector2f normal(p1.y - p2.y, p2.x - p1.x);
    ...
    float dotProduct(const ae::Vector2f& p1, const ae::Vector2f& p2)
    {
